...
static inline void mec_pcr_periph_slp_ctrl(PCR_ID pcr_id, uint8_t enable)
__attribute__ ((always_inline, alias("mchp_pcr_periph_slp_ctrl")));
...
static inline void mec_pcr_periph_reset(PCR_ID pcr_id)
__attribute__ ((always_inline, alias("mchp_pcr_periph_reset")));
