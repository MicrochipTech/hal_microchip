...
int mec_hal_espi_capability_get(uintptr_t ioc_base, enum mec_espi_global_cap cap, uint32_t *cfg);

int mec_hal_espi_cap_set(uintptr_t ioc_base, enum mec_espi_cap_id id, uint32_t cfg);
uint32_t mec_hal_espi_cap_get(uintptr_t ioc_base, enum mec_espi_cap_id id);
...
int mec_hal_espi_is_activated(uintptr_t ioc_base);
