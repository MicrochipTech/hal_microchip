...
#define MEC_ESPI_TAF_DONE_ECIA_INFO \
    MEC_ECIA_INFO(MEC_ESPI_TAF_GIRQ, MEC_ESPI_TAF_DONE_GIRQ_POS, MEC_ESPI_TAF_GIRQ_AGGR_NVIC,\
                  MEC_ESPI_TAF_DONE_NVIC)
#define MEC_ESPI_TAF_ERR_ECIA_INFO  \
    MEC_ECIA_INFO(MEC_ESPI_TAF_GIRQ, MEC_ESPI_TAF_ERR_GIRQ_POS, MEC_ESPI_TAF_GIRQ_AGGR_NVIC,\
