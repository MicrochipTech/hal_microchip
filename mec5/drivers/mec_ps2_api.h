...
enum mec_ps2_status {
    MEC_PS2_STS_DATA_RDY = BIT(0),
    MEC_PS2_STS_RX_TMOUT = BIT(1),
    MEC_PS2_STS_PARITY_ERR = BIT(2),
    MEC_PS2_STS_FRAME_ERR = BIT(3),
    MEC_PS2_STS_TX_IDLE = BIT(4),
    MEC_PS2_STS_TX_TMOUT = BIT(5),
    MEC_PS2_STS_RX_BUSY = BIT(6),
    MEC_PS2_STS_TX_START_TMOUT = BIT(7),
};
