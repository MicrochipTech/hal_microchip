...
#define MEC_ESPI_SIRQ_DIS_VAL 0xffu

enum mec_espi_sirq_slot_id {
    MEC_ESPI_SIRQ_MBOX_IRQ = 0,
    MEC_ESPI_SIRQ_MBOX_SMI,
    MEC_ESPI_SIRQ_KBC_KIRQ,
    MEC_ESPI_SIRQ_KBC_MIRQ,
    MEC_ESPI_SIRQ_ACPI_EC0_OBF,
    MEC_ESPI_SIRQ_ACPI_EC1_OBF,
    MEC_ESPI_SIRQ_ACPI_EC2_OBF,
    MEC_ESPI_SIRQ_ACPI_EC3_OBF,
    MEC_ESPI_SIRQ_ACPI_EC4_OBF,
    MEC_ESPI_SIRQ_UART0,
    MEC_ESPI_SIRQ_UART1,
    MEC_ESPI_SIRQ_EMI0_HEV,
    MEC_ESPI_SIRQ_EMI0_E2H,
    MEC_ESPI_SIRQ_EMI1_HEV,
    MEC_ESPI_SIRQ_EMI1_E2H,
    MEC_ESPI_SIRQ_EMI2_HEV,
    MEC_ESPI_SIRQ_EMI2_E2H,
    MEC_ESPI_SIRQ_RTC,
    MEC_ESPI_SIRQ_EC, 
    MEC_ESPI_SIRQ_UART2,
    MEC_ESPI_SIRQ_PP,
...
uint32_t mec_hal_espi_pc_ltr_status(const uintptr_t iobase);
void mec_hal_espi_pc_ltr_intr_en(const uintptr_t iobase, uint32_t enmask);
void mec_hal_espi_pc_ltr_ctrl(const uintptr_t iobase, uint8_t tag, uint8_t start);
void mec_hal_espi_pc_ltr_msg(const uintptr_t iobase, uint16_t nunits, uint8_t time_unit,
...
int mec_hal_espi_bar_inhibit_msk(const uintptr_t regbase, uint8_t inhibit,
...
int mec_hal_espi_sram_bar_host_addr_set(const uintptr_t mrbase, uint8_t sram_bar_id,
