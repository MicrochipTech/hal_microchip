...
void mec_hal_espi_vw_ct_from_girq_pos(uint8_t bank, uint8_t girq_pos, uint8_t *ctidx,
                                      uint8_t *ctsrc);

/* returns b[7:0] = VW group register index, b[15:8] = VW source position [0, 3] */
uint32_t mec_hal_espi_girq_pos_to_ct_vw(uint8_t bank, uint8_t girq_pos);

int mec_hal_espi_vw_ct_irq_sel_set(uintptr_t vwrb, uint8_t vw_idx, uint8_t src_idx,
                                   uint8_t irq_sel);
...
int mec_hal_espi_vw_ct_reset_state_set(uintptr_t vwrb, uint8_t ctidx, uint8_t src_idx,
                                       uint8_t reset_state);
int mec_hal_espi_vw_ct_irqsel_set(uintptr_t vwrb, uint8_t ctidx, uint8_t src_idx, uint8_t irq_sel);
...
int mec_hal_espi_vw_get_src(uintptr_t vwrb, struct mec_espi_vw *vw, uint32_t flags);
...
int mec_hal_espi_vw_get_src_group(uintptr_t vwrb, struct mec_espi_vw *vw, uint32_t flags);
...
int mec_hal_espi_vw_set_cs(uintptr_t vwrb, uint8_t host_index,
