...
#define MEC_ADC_SM_ECIA_INFO MEC_ECIA_INFO(MEC_ADC_GIRQ, MEC_ADC_SM_GIRQ_POS, 9, 78)
#define MEC_ADC_RM_ECIA_INFO MEC_ECIA_INFO(MEC_ADC_GIRQ, MEC_ADC_RM_GIRQ_POS, 9, 79)
