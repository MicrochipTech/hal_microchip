...
#ifndef _MEC_ESPI_REGS_H_
#define _MEC_ESPI_REGS_H_

#include "mec_defs.h"

#define MEC_ESPI_IOC_BASE           0x400F3400UL
#define MEC_ESPI_MC_BASE            0x400F3800UL
#define MEC_ESPI_VWC_BASE           0x400F9C00UL
...
#define MEC_ESPI_CAP0_SUPP_MSK              MEC_GENMASK(3, 0)
...
#define MEC_ESPI_CAP1_MAX_FREQ_MSK          MEC_GENMASK(2, 0)
#define MEC_ESPI_CAP1_MAX_FREQ_20M          MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, 0)
#define MEC_ESPI_CAP1_MAX_FREQ_25M          MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, 1)
#define MEC_ESPI_CAP1_MAX_FREQ_33M          MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, 2)
#define MEC_ESPI_CAP1_MAX_FREQ_50M          MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, 3)
#define MEC_ESPI_CAP1_MAX_FREQ_66M          MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, 4)
#define MEC_ESPI_CAP1_MAX_FREQ_SET(f)       MEC_FIELD_PREP(MEC_ESPI_CAP1_MAX_FREQ_MSK, (f))
#define MEC_ESPI_CAP1_MAX_FREQ_GET(f)       MEC_FIELD_GET(MEC_ESPI_CAP1_MAX_FREQ_MSK, (f))
#define MEC_ESPI_CAP1_ALERT_MODE_PIN_POS    3
#define MEC_ESPI_CAP1_IOM_POS               4
#define MEC_ESPI_CAP1_IOM_MSK               MEC_GENMASK(5, 4)
...
#define MEC_ESPI_CAP1_IOM_S                 MEC_FIELD_PREP(MEC_ESPI_CAP1_IOM_MSK, 0)
#define MEC_ESPI_CAP1_IOM_SD                MEC_FIELD_PREP(MEC_ESPI_CAP1_IOM_MSK, 1)
#define MEC_ESPI_CAP1_IOM_SQ                MEC_FIELD_PREP(MEC_ESPI_CAP1_IOM_MSK, 2)
#define MEC_ESPI_CAP1_IOM_SDQ               MEC_FIELD_PREP(MEC_ESPI_CAP1_IOM_MSK, 3)
#define MEC_ESPI_CAP1_IOM_SET(iom)          MEC_FIELD_PREP(MEC_ESPI_CAP1_IOM_MSK, (iom))
#define MEC_ESPI_CAP1_IOM_GET(iom)          MEC_FIELD_GET(MEC_ESPI_CAP1_IOM_MSK, (iom))
...
#define MEC_ESPI_CAP_PC_MPLS_MSK            MEC_GENMASK(2, 0)
#define MEC_ESPI_CAP_PC_MPLS_64B            MEC_FIELD_PREP(MEC_ESPI_CAP_PC_MPLS_MSK, 1)
#define MEC_ESPI_CAP_PC_MPLS_DFLT           MEC_ESPI_CAP_PC_MPLS_64B
#define MEC_ESPI_CAP_PC_MPLS_SET(n)         MEC_FIELD_PREP(MEC_ESPI_CAP_PC_MPLS_MSK, (n))
#define MEC_ESPI_CAP_PC_MPLS_GET(n)         MEC_FIELD_GET(MEC_ESPI_CAP_PC_MPLS_MSK, (n))

#define MEC_ESPI_CAP_VW_OFS                0x2e4u
#define MEC_ESPI_CAP_VW_MAX_GRPS_POS       0
#define MEC_ESPI_CAP_VW_MAX_GRPS_MSK       MEC_GENMASK(5, 0)
#define MEC_ESPI_CAP_VW_MAX_GRPS_8         MEC_FIELD_PREP(MEC_ESPI_CAP_VW_MAX_GRPS_MSK, 7)
#define MEC_ESPI_CAP_VW_MAX_GRPS_64        MEC_FIELD_PREP(MEC_ESPI_CAP_VW_MAX_GRPS_MSK, 0x3F)
#define MEC_ESPI_CAP_VW_MAX_GRPS_DFLT      MEC_ESPI_CAP_VW_MAX_GRPS_64
#define MEC_ESPI_CAP_VW_MAX_GRPS_SET(nvwg) MEC_FIELD_PREP(MEC_ESPI_CAP_VW_MAX_GRPS_MSK, (nvwg))
#define MEC_ESPI_CAP_VW_MAX_GRPS_GET(nvwg) MEC_FIELD_GET(MEC_ESPI_CAP_VW_MAX_GRPS_MSK, (nvwg))

#define MEC_ESPI_CAP_OOB_OFS            0x2e5u
#define MEC_ESPI_CAP_OOB_MPLD_POS       0
#define MEC_ESPI_CAP_OOB_MPLD_MSK       MEC_GENMASK(2, 0)
#define MEC_ESPI_CAP_OOB_MPLD_73        MEC_FIELD_PREP(MEC_ESPI_CAP_OOB_MPLS_MSK, 1)
#define MEC_ESPI_CAP_OOB_MPLD_DFLT      MEC_ESPI_CAP_OOB_MPLD_73
#define MEC_ESPI_CAP_OOB_MPLD_SET(v)    MEC_FIELD_PREP(MEC_ESPI_CAP_OOB_MPLD_MSK, (v))
#define MEC_ESPI_CAP_OOB_MPLD_GET(v)    MEC_FIELD_GET(MEC_ESPI_CAP_OOB_MPLD_MSK, (v))

#define MEC_ESPI_CAP_FC_OFS             0x2e6u
#define MEC_ESPI_CAP_FC_MPLD_POS        0
#define MEC_ESPI_CAP_FC_MPLD_MSK        MEC_GENMASK(2, 0)
#define MEC_ESPI_CAP_FC_MPLD_64         MEC_FIELD_PREP(MEC_ESPI_CAP_FC_MPLD_MSK, 1)
#define MEC_ESPI_CAP_FC_MPLD_SET(n)     MEC_FIELD_PREP(MEC_ESPI_CAP_FC_MPLD_MSK, (n))
#define MEC_ESPI_CAP_FC_MPLD_GET(n)     MEC_FIELD_GET(MEC_ESPI_CAP_FC_MPLD_MSK, (n))

#define MEC_ESPI_CAP_FC_SM_POS          3
#define MEC_ESPI_CAP_FC_SM_MSK          MEC_GENMASK(4, 3)
#define MEC_ESPI_CAP_FC_SM_CAF          MEC_FIELD_PREP(MEC_ESPI_CAP_FC_SM_MSK, 0)
#define MEC_ESPI_CAP_FC_SM_CAF_ALT      MEC_FIELD_PREP(MEC_ESPI_CAP_FC_SM_MSK, 1)
#define MEC_ESPI_CAP_FC_SM_TAF          MEC_FIELD_PREP(MEC_ESPI_CAP_FC_SM_MSK, 2)
#define MEC_ESPI_CAP_FC_SM_CAF_TAF      MEC_FIELD_PREP(MEC_ESPI_CAP_FC_SM_MSK, 3)
#define MEC_ESPI_CAP_FC_SM_SET(sm)      MEC_FIELD_PREP(MEC_ESPI_CAP_FC_SM_MSK, (sm))
#define MEC_ESPI_CAP_FC_SM_GET(sm)      MEC_FIELD_GET(MEC_ESPI_CAP_FC_SM_MSK, (sm))

/* TAF maximum read request size */
#define MEC_ESPI_CAP_FC_TAF_MRRQ_POS    5
#define MEC_ESPI_CAP_FC_TAF_MRRQ_MSK    MEC_GENMASK(7, 5)
#define MEC_ESPI_CAP_FC_TAF_MRRQ_64     MEC_FIELD_PREP(MEC_ESPI_CAP_FC_TAF_MRRQ_MSK, 1)
#define MEC_ESPI_CAP_FC_TAF_MRRQ_SET(n) MEC_FIELD_PREP(MEC_ESPI_CAP_FC_TAF_MRRQ_MSK, (n))
#define MEC_ESPI_CAP_FC_TAF_MRRQ_GET(n) MEC_FIELD_GET(MEC_ESPI_CAP_FC_TAF_MRRQ_MSK, (n))
...
#define MEC_ESPI_RPMC_CFG1_NFL_MSK     MEC_GENMASK(7, 6)
#define MEC_ESPI_RPMC_CFG1_NFL_1       MEC_FIELD_PREP(MEC_ESPI_RPMC_OP1_CFG_NFL_MSK, 0)
#define MEC_ESPI_RPMC_CFG1_NFL_2       MEC_FIELD_PREP(MEC_ESPI_RPMC_OP1_CFG_NFL_MSK, 1)
#define MEC_ESPI_RPMC_CFG1_CT_POS      8 /* total number of counters */
#define MEC_ESPI_RPMC_CFG1_CT_MSK      MEC_GENMASK(13, 8)
#define MEC_ESPI_RPMC_CFG1_CT(ct)      MEC_FIELD_PREP(MEC_ESPI_RPMC_OP1_CFG_CT_MSK, (ct))
...
#define MEC_ESPI_RPMC_CFG2_OPC0_MSK  MEC_GENMASK(7, 0)
#define MEC_ESPI_RPMC_CFG2_OPC0(opc) MEC_FIELD_PREP(MEC_ESPI_RPMC_CFG2_OPC0_MSK, (opc))
#define MEC_ESPI_RPMC_CFG2_CNTC0_POS 8
#define MEC_ESPI_RPMC_CFG2_CNTC0_MSK MEC_GENMASK(12, 8)
#define MEC_ESPI_RPMC_CFG2_CNTC0(nc) MEC_FIELD_PREP(MEC_ESPI_RPMC_CFG2_CNTC0_MSK, (nc))
#define MEC_ESPI_RPMC_CFG2_OPC1_POS  16 /* RPMC OP1 opcode for device connected to CS1 */
#define MEC_ESPI_RPMC_CFG2_OPC1_MSK  MEC_GENMASK(23, 16)
#define MEC_ESPI_RPMC_CFG2_OPC1(opc) MEC_FIELD_PREP(MEC_ESPI_RPMC_CFG2_OPC1_MSK, (opc))
#define MEC_ESPI_RPMC_CFG2_CNTC1_POS 24
#define MEC_ESPI_RPMC_CFG2_CNTC1_MSK MEC_GENMASK(28, 24)
#define MEC_ESPI_RPMC_CFG2_CNTC1(nc) MEC_FIELD_PREP(MEC_ESPI_RPMC_CFG2_CNTC1_MSK, (nc))
...
#define MEC_ESPI_ECB_AMSK_MSK      MEC_GENMASK(7, 0)
#define MEC_ESPI_ECB_AMSK_SET(n)   MEC_FIELD_PREP(MEC_ESPI_ECB_AMSK_MSK, (n))
#define MEC_ESPI_ECB_AMSK_GET(n)   MEC_FIELD_GET(MEC_ESPI_ECB_AMSK_MSK, (n))
#define MEC_ESPI_ECB_LD_POS        8
#define MEC_ESPI_ECB_LD_MSK        MEC_GENMASK(13, 8)
#define MEC_ESPI_ECB_LD_MSK_GET(n) MEC_FIELD_GET(MEC_ESPI_ECB_LD_MSK, (n))
...
#define MEC_ESPI_HBV_BASE_MSK0      MEC_GENMASK(15, 0)
#define MEC_ESPI_HBV_BASE_MSK       MEC_GENMASK(31, 16)
#define MEC_ESPI_HBV_BASE_SET(b)    MEC_FIELD_PREP(MEC_ESPI_HBV_BASE_MSK, (b))
#define MEC_ESPI_HBV_BASE_GET(h)    MEC_FIELD_GET(MEC_ESPI_HBV_BASE_MSK, (b))
...
#define MEC_ESPI_PC_LC_LTT_LEN_MSK    MEC_GENMASK(11, 0)
#define MEC_ESPI_PC_LC_LTT_LEN_GET(n) MEC_FIELD_GET(MEC_ESPI_PC_LC_LTT_LEN_MSK, (n))
#define MEC_ESPI_PC_LC_LTT_TYPE_POS   12
#define MEC_ESPI_PC_LC_LTT_TYPE_MSK   MEC_GENMASK(19, 12)
#define MEC_ESPI_PC_LC_LTT_TYPE_GET(n) MEC_FIELD_GET(MEC_ESPI_PC_LC_LTT_TYPE_MSK, (n))
#define MEC_ESPI_PC_LC_LTT_TAG_POS    20
#define MEC_ESPI_PC_LC_LTT_TAG_MSK    MEC_GENMASK(23, 20)
#define MEC_ESPI_PC_LC_LTT_TAG_GET(n) MEC_FIELD_PREP(MEC_ESPI_PC_LC_LTT_TAG_MSK, (n))

#define MEC_ESPI_PC_ERA_LSW_OFS       0x10cu
#define MEC_ESPI_PC_ERA_MSW_OFS       0x110u

#define MEC_ESPI_PC_SR_OFS            0x114u
#define MEC_ESPI_PC_SR_ABERR_POS      16
#define MEC_ESPI_PC_SR_CHEN_STATE_POS 24 /* RO */
#define MEC_ESPI_PC_SR_CHEN_CHG_POS   25
#define MEC_ESPI_PC_SR_BMEN_STATE_POS 27 /* RO */
#define MEC_ESPI_PC_SR_BMEN_CHG_POS   28
#define MEC_ESPI_PC_SR_ALL_MSK        \
        (MEC_BIT(MEC_ESPI_PC_SR_ABERR_POS) | MEC_BIT(MEC_ESPI_PC_SR_CHEN_STATE_POS) |\
         MEC_BIT(MEC_ESPI_PC_SR_CHEN_CHG_POS) | MEC_BIT(MEC_ESPI_PC_SR_BMEN_STATE_POS) |\
         MEC_BIT(MEC_ESPI_PC_SR_BMEN_CHG_POS))
...
#define MEC_ESPI_PC_LTR_CR_TAG_OUT_MSK    MEC_GENMASK(11, 8)
#define MEC_ESPI_PC_LTR_CR_TAG_OUT_SET(t) MEC_FIELD_PREP(MEC_ESPI_PC_LTR_CR_TAG_OUT_MSK, (t))

#define MEC_ESPI_PC_LTR_MSG_OFS           0x22cu
#define MEC_ESPI_PC_LTR_MSG_ALL_MSK       MEC_GENMASK(15, 0)
#define MEC_ESPI_PC_LTR_MSG_TV_POS        0 /* time value */
#define MEC_ESPI_PC_LTR_MSG_TV_MSK        MEC_GENMASK(9, 0)
#define MEC_ESPI_PC_LTR_MSG_TV_SET(t)     MEC_FIELD_PREP(MEC_ESPI_PC_LTR_MSG_TV_MSK, (t))
#define MEC_ESPI_PC_LTR_MSG_SC_POS        10 /* scale field: time units */
#define MEC_ESPI_PC_LTR_MSG_SC_MSK        MEC_GENMASK(12, 10)
#define MEC_ESPI_PC_LTR_MSG_SC_SET(sc)    MEC_FIELD_PREP(MEC_ESPI_PC_LTR_MSG_SC_MSK, (sc))
#define MEC_ESPI_PC_LTR_MSG_RTXB_POS      13
#define MEC_ESPI_PC_LTR_MSG_RTXB_MSK      MEC_GENMASK(14, 13)
#define MEC_ESPI_PC_LTR_MSG_RTXB_SET(r)   MEC_FIELD_PREP(MEC_ESPI_PC_LTR_MSG_RTXB_MSK, (r))
...
#define MEC_ESPI_OOB_RXL_MLEN_MSK    MEC_GENMASK(12, 0) /* number of bytes received (RO) */
#define MEC_ESPI_OOB_RXL_MLEN_GET(n) MEC_FIELD_GET(MEC_ESPI_OOB_RXL_MLEN_MSK, (n))
#define MEC_ESPI_OOB_RXL_BLEN_POS    16
#define MEC_ESPI_OOB_RXL_BLEN_MSK    MEC_GENMASK(28, 16) /* max RX mesg length (RW) */
#define MEC_ESPI_OOB_RXL_BLEN_SET(n) MEC_FIELD_PREP(MEC_ESPI_OOB_RXL_BLEN_MSK, (n))

#define MEC_ESPI_OOB_TXL_OFS         0x254u
#define MEC_ESPI_OOB_TXL_MLEN_POS    0
#define MEC_ESPI_OOB_TXL_MLEN_MSK    MEC_GENMASK(12, 0) /* number of byte to transmit (RW) */
#define MEC_ESPI_OOB_TXL_MLEN_SET(n) MEC_FIELD_PREP(MEC_ESPI_OOB_TXL_MLEN_MSK, (n))
#define MEC_ESPI_OOB_TXL_MLEN_GET(n) MEC_FIELD_GET(MEC_ESPI_OOB_TXL_MLEN_MSK, (n))
...
#define MEC_ESPI_OOB_MPLD_SZ_MSK     MEC_GENMASK(18, 16)
#define MEC_ESPI_OOB_MPLD_SZ_GET(n)  MEC_FIELD_GET(MEC_ESPI_OOB_MPLD_SZ_MSK, (n))
...
#define MEC_ESPI_OOB_RX_SR_ALL_ERR_MSK MEC_GENMASK(2, 1)
#define MEC_ESPI_OOB_RX_SR_RXBA_POS    3 /* RO */
#define MEC_ESPI_OOB_RX_TAG_IN_POS     8
#define MEC_ESPI_OOB_RX_TAG_IN_MSK     MEC_GENMASK(11, 8)
#define MEC_ESPI_OOB_RX_TAG_IN_GET(tv) MEC_FIELD_GET(ESPI_OOB_RX_TAG_IN_MSK, (tv))

#define MEC_ESPI_OOB_TX_CR_OFS       0x264u
#define MEC_ESPI_OOB_TX_CR_START_POS 0 /* WO */
#define MEC_ESPI_OOB_TX_TAG_POS      8
#define MEC_ESPI_OOB_TX_TAG_MSK      MEC_GENMASK(11, 8)
#define MEC_ESPI_OOB_TX_TAG_SET(t)   MEC_FIELD_PREP(MEC_ESPI_OOB_TX_TAG_MSK, (t))
#define MEC_ESPI_OOB_TX_TAG_GET(t)   MEC_FIELD_GET(MEC_ESPI_OOB_TX_TAG_MSK, (t))
...
#define MEC_ESPI_OOB_TX_SR_ALL_ERR_MSK (MEC_GENMASK(3, 2) | MEC_BIT(5))
...
#define MEC_ESPI_FC_BA_MSK             MEC_GENMASK(31, 2)
...
#define MEC_ESPI_FC_CR_FUNC_MSK      MEC_GENMASK(3, 2)
#define MEC_ESPI_FC_CR_FUNC_READ     MEC_FIELD_PREP(MEC_ESPI_FC_CR_FUNC_MSK, 0)
#define MEC_ESPI_FC_CR_FUNC_WRITE    MEC_FIELD_PREP(MEC_ESPI_FC_CR_FUNC_MSK, 1)
#define MEC_ESPI_FC_CR_FUNC_ERASE_SM MEC_FIELD_PREP(MEC_ESPI_FC_CR_FUNC_MSK, 2)
#define MEC_ESPI_FC_CR_FUNC_ERASE_LG MEC_FIELD_PREP(MEC_ESPI_FC_CR_FUNC_MSK, 3)
...
#define MEC_ESPI_FC_CR_TAG_MSK       MEC_GENMASK(7, 4)
#define MEC_ESPI_FC_CR_TAG_SET(t)    MEC_FIELD_PREP(MEC_ESPI_FC_CR_TAG_MSK, (t))
#define MEC_ESPI_FC_CR_TAG_GET(t)    MEC_FIELD_GET(MEC_ESPI_FC_CR_TAG_MSK, (t))
...
#define MEC_ESPI_FC_CFG_EBSZ_MSK        MEC_GENMASK(4, 2)
...
#define MEC_ESPI_FC_CFG_EBSZ_4K         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_EBSZ_MSK, MEC_ESPI_FC_CFG_EBSZ_4K_VAL)
#define MEC_ESPI_FC_CFG_EBSZ_64K        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_EBSZ_MSK, MEC_ESPI_FC_CFG_EBSZ_64K_VAL)
#define MEC_ESPI_FC_CFG_EBSZ_4K_64K     MEC_FIELD_PREP(MEC_ESPI_FC_CFG_EBSZ_MSK, MEC_ESPI_FC_CFG_EBSZ_4K_64K_VAL)
#define MEC_ESPI_FC_CFG_EBSZ_128K       MEC_FIELD_PREP(MEC_ESPI_FC_CFG_EBSZ_MSK, MEC_ESPI_FC_CFG_EBSZ_128K_VAL)
#define MEC_ESPI_FC_CFG_EBSZ_256K       MEC_FIELD_PREP(MEC_ESPI_FC_CFG_EBSZ_MSK, MEC_ESPI_FC_CFG_EBSZ_256K_VAL)
#define MEC_ESPI_FC_CFG_EBSZ_GET(rv)    MEC_FIELD_GET(MEC_ESPI_FC_CFG_EBSZ_MSK, (rv))
#define MEC_ESPI_FC_CFG_MPLD_POS        8
#define MEC_ESPI_FC_CFG_MPLD_MSK        MEC_GENMASK(10, 8)
#define MEC_ESPI_FC_CFG_MPLD_64_VAL     1
#define MEC_ESPI_FC_CFG_MPLD_128_VAL    2
#define MEC_ESPI_FC_CFG_MPLD_256_VAL    3
#define MEC_ESPI_FC_CFG_MPLD_64         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MPLD_MSK, MEC_ESPI_FC_CFG_MPLD_64_VAL)
#define MEC_ESPI_FC_CFG_MPLD_128        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MPLD_MSK, MEC_ESPI_FC_CFG_MPLD_128_VAL)
#define MEC_ESPI_FC_CFG_MPLD_256        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MPLD_MSK, MEC_ESPI_FC_CFG_MPLD_256_VAL)
#define MEC_ESPI_FC_CFG_MPLD_GET(rv)    MEC_FIELD_GET(MEC_ESPI_FC_CFG_MPLD_MSK, (rv)) /* rv = register value */
#define MEC_ESPI_FC_CFG_TAF_MODE_POS    11
#define MEC_ESPI_FC_CFG_MRDR_POS        12
#define MEC_ESPI_FC_CFG_MRDR_MSK        MEC_GENMASK(14, 12)
...
#define MEC_ESPI_FC_CFG_MRDR_64         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_64_VAL)
#define MEC_ESPI_FC_CFG_MRDR_128        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_128_VAL)
#define MEC_ESPI_FC_CFG_MRDR_256        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_256_VAL)
#define MEC_ESPI_FC_CFG_MRDR_512        MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_512_VAL)
#define MEC_ESPI_FC_CFG_MRDR_1K         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_1K_VAL)
#define MEC_ESPI_FC_CFG_MRDR_2K         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_2K_VAL)
#define MEC_ESPI_FC_CFG_MRDR_4K         MEC_FIELD_PREP(MEC_ESPI_FC_CFG_MRDR_MSK, MEC_ESPI_FC_CFG_MDRD_4K_VAL)
#define MEC_ESPI_FC_CFG_MRDR_GET(rv)    MEC_FIELD_GET(MEC_ESPI_FC_CFG_MRDR_MSK, (rv))
...
#define MEC_ESPI_FC_SR_ERR_ALL_MSK      MEC_GENMASK(11, 3)
#define MEC_ESPI_FC_SR_ALL_MSK          MEC_GENMASK(11, 0)
...
#define MEC_ESPI_MC_BAR_AMLD_MSK_MSK    MEC_GENMASK(7, 0)
#define MEC_ESPI_MC_BAR_AMLD_MSK_SET(n) MEC_FIELD_PREP(MEC_ESPI_MC_BAR_AMLD_MSK_MSK, (n))
#define MEC_ESPI_MC_BAR_AMLD_MSK_GET(n) MEC_FIELD_GET(MEC_ESPI_MC_BAR_AMLD_MSK_MSK, (n))
#define MEC_ESPI_MC_BAR_AMLD_LD_POS     8
#define MEC_ESPI_MC_BAR_AMLD_LD_MSK     MEC_GENMASK(13, 8)
#define MEC_ESPI_MC_BAR_AMLD_LD_SET(n)  MEC_FIELD_PREP(MEC_ESPI_MC_BAR_AMLD_LD_MSK, (n))
#define MEC_ESPI_MC_BAR_AMLD_LD_GET(n)  MEC_FIELD_GET(MEC_ESPI_MC_BAR_AMLD_LD_MSK, (n))
...
#define MEC_ESPI_MC_SBAR_ACC_MSK    MEC_GENMASK(2, 1)
#define MEC_ESPI_MC_SBAR_ACC_SET(n) MEC_FIELD_PREP(MEC_ESPI_MC_SBAR_ACC_MSK, (n))
#define MEC_ESPI_MC_SBAR_ACC_GET(n) MEC_FIELD_GET(MEC_ESPI_MC_SBAR_ACC_MSK, (n))

#define MEC_ESPI_MC_SBAR_SZ_POS     4
#define MEC_ESPI_MC_SBAR_SZ_MSK     MEC_GENMASK(7, 4)
#define MEC_ESPI_MC_SBAR_SZ_SET(sz) MEC_FIELD_PREP(MEC_ESPI_MC_SBAR_SZ_MSK, (sz))
#define MEC_ESPI_MC_SBAR_SZ_GET(sz) MEC_FIELD_GET(MEC_ESPI_MC_SBAR_SZ_MSK, (sz))
...
#define MEC_ESPI_VW_W0_HI_MSK        MEC_GENMASK(7, 0)
#define MEC_ESPI_VW_W0_HI_SET(hi)    MEC_FIELD_PREP(MEC_ESPI_VW_W0_HI_MSK, (hi))
#define MEC_ESPI_VW_W0_HI_GET(hi)    MEC_FIELD_GET(MEC_ESPI_VW_W0_HI_MSK, (hi))

#define MEC_ESPI_VW_W0_RSRC_POS      8
#define MEC_ESPI_VW_W0_RSRC_MSK      MEC_GENMASK(9, 8)
#define MEC_ESPI_VW_W0_RSRC_ESPI_RST MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSRC_MSK, 0)
#define MEC_ESPI_VW_W0_RSRC_SYS_RST  MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSRC_MSK, 1)
#define MEC_ESPI_VW_W0_RSRC_SIO_RST  MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSRC_MSK, 2)
#define MEC_ESPI_VW_W0_RSRC_PLT_RST  MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSRC_MSK, 3)
#define MEC_ESPI_VW_W0_RSRC_SET(r)   MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSRC_MSK, (r))
#define MEC_ESPI_VW_W0_RSRC_GET(r)   MEC_FIELD_GET(MEC_ESPI_VW_W0_RSRC_MSK, (r))

#define MEC_ESPI_VW_W0_RSTATE_POS    12 /* bitmap of the 4 vwires in the group */
#define MEC_ESPI_VW_W0_RSTATE_MSK    MEC_GENMASK(15, 12)
#define MEC_ESPI_VW_W0_RSTATE_SET(r) MEC_FIELD_PREP(MEC_ESPI_VW_W0_RSTATE_MSK, (r))
#define MEC_ESPI_VW_W0_RSTATE_GET(r) MEC_FIELD_GET(MEC_ESPI_VW_W0_RSTATE_MSK, (r))
...
#define MEC_ESPI_VW_H2T_W1_ISEL_MSK(s)                                  \
    MEC_GENMASK(MEC_ESPI_VW_H2T_W1_ISEL_POS(s) + 3, MEC_ESPI_VW_H2T_W1_ISEL_POS(s))
#define MEC_ESPI_VW_H2T_W1_ISEL_SET(s, i) \
    MEC_FIELD_PREP(MEC_ESPI_VW_H2T_W1_ISEL_MSK(s), (i))
#define MEC_ESPI_VW_H2T_W1_ISEL_GET(s, i) \
    MEC_FIELD_GET(MEC_ESPI_VW_H2T_W1_ISEL_MSK(s), (i))
