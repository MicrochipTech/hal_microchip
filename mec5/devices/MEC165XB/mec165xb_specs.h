 ...
 *
 */
#ifndef __MEC165XB_SPECS_H__
#define __MEC165XB_SPECS_H__

/* MEC1651B No internal EEPROM or SPI flash
 * MEC1653B includes internal 8KB EEPROM
 * MEC1657B includes internal 512KB SPI flash
 * SZ package is 144 pin WFBGA: 123 GPIOs
 * TF package is 128 pin WFBGA: 108 GPIOs
 */
#define MEC5_MEC165XB    1
...
#define MEC5_PKG_WFBGA_128 0x3u
#define MEC5_PKG_WFBGA_144 0x4u

#define MEC1651B_NTF_DEV_ID 0x002df300u
#define MEC1653B_NTF_DEV_ID 0x002d6300u
#define MEC1657B_NTF_DEV_ID 0x002d6300u

#define MEC1651B_NSZ_DEV_ID 0x002df400u
#define MEC1653B_NSZ_DEV_ID 0x002d6400u
#define MEC1657B_NSZ_DEV_ID 0x002de400u
...
#if defined(CONFIG_SOC_MICROCHIP_MEC_PKG_WFBGA_128)
#define MEC5_CCT_CHANNELS          13
#else
...
#if defined(CONFIG_SOC_MICROCHIP_MEC_PKG_WFBGA_128)
#define MEC5_GPIO_TOTAL_PINS    108u
#define MEC5_GPIO_GPTP_PINS     6
#else
#define MEC5_GPIO_TOTAL_PINS    123u
#define MEC5_GPIO_GPTP          8
#endif

#define MEC5_I2C_SMB_HW_VER                 38u
#define MEC5_I2C_SMB_HAS_STOP_DETECT_IRQ
#define MEC5_I2C_SMB_INSTANCES              5u
#define MEC5_I2C_SMB_BAUD_CLOCK             16000000u
#if defined(CONFIG_SOC_MICROCHIP_MEC_PKG_WFBGA_128)
#define MEC5_I2C_SMB_PORTS                  15
#define MEC5_I2C_SMB_PORT_MAP               0x7fffu
#else
#define MEC5_I2C_SMB_PORTS                  16
...
#else
#define MEC5_PWM_INSTANCES                  11
#define MEC5_TACH_INSTANCES                 8
#endif
